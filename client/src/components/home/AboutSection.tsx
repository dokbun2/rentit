...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-20 pt-24 bg-[#121212] relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <div className="flex flex-col items-start gap-4 mb-8 w-full max-w-md mx-auto pl-16 md:pl-36">
