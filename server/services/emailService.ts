...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: process.env.EMAIL_USER || 'your-email@gmail.com', // 환경변수에서 이메일 주소 가져옴
    pass: process.env.EMAIL_PASSWORD || 'your-app-password', // 환경변수에서 앱 비밀번호 가져옴 (Gmail은 앱 비밀번호 필요)
  },
});
